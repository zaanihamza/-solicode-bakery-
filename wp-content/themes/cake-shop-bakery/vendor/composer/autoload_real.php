...
class cake_shop_bakery_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function cake_shop_bakery_loadClassLoader($class)
    {
    ...
    public static function cake_shop_bakery_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
