...
class Cake_Shop_Bakery_Loader {
	 ...
	 * @return void
	 */
	public function cake_shop_bakery_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function cake_shop_bakery_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function cake_shop_bakery_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function cake_shop_bakery_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->cake_shop_bakery_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function cake_shop_bakery_load( $class ) {
