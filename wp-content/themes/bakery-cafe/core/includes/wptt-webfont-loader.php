...
if ( ! class_exists( 'Bakery_Cafe_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Bakery_Cafe_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Bakery_Cafe_WPTT_WebFont_Loader( $url );
